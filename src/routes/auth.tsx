...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Admin Login — KasaraCare" },
      { name: "description", content: "Sign in to the KasaraCare administration." },
    ],
  }),
  component: AuthPage,
});
...
function AuthPage() {
  ...
  return (
    ...
    >
      ...
      {/* ========================================== */}
      <div className="flex w-full max-w-225 rounded-4xl shadow-2xl border border-white/60 bg-white/80 backdrop-blur-xl overflow-hidden">
        ...
        <div className="hidden md:flex w-1/2 flex-col items-center justify-center bg-blue-50/60 p-10 relative">
          ...
          <div className="absolute inset-0 bg-linear-to-b from-[#00a2ed]/5 to-transparent"></div>
        ...
        <div className="flex w-full md:w-1/2 flex-col justify-center p-8 sm:p-12 bg-white">
          <Link
            to="/"
            className="mb-8 flex items-center justify-center gap-3 hover:opacity-90 transition-opacity"
          >
            ...
            <div>
              <p className="font-display text-2xl font-bold leading-none text-slate-900 tracking-tight">
                KasaraCare
              </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                required
                placeholder="admin@kasaracare.com"
          ...
          <Button
            variant="outline"
            className="w-full h-11 font-semibold text-slate-600 border-slate-200 hover:bg-slate-50"
